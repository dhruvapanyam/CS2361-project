    ...
    try {
        ...
        if(choice == 'certificates'){
            ...
            for(let attr of retrieveIdentity.result.attrs){
                if(attr.name == 'userID') uid = attr.value;
                if(attr.name == 'user_type') utype = attr.value;
            ...
            console.log('GENESIS TRAIL OUTPUT:')
            console.log(JSON.stringify({userID:uid,user_type:utype}));
        }    
